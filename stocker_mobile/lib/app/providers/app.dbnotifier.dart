...
class DataBaseNotifier extends ChangeNotifier {
  ...
  dynamic insert({
    ...
    return await dataBService.insert(tabela: tabela, map: map);
  }
  ...
  dynamic select({
    ...
    return await dataBService.select(
        tabela: tabela, select: select, where: where);
  }
  ...
  update(
    ...
    await dataBService.update(tabela: tabela, where: where, setValue: setValue);
  }
